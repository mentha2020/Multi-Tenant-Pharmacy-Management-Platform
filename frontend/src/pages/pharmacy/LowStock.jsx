        ...
        <table className="w-full">
          ...
          <tbody className="divide-y divide-gray-200">
            {loading ? (
              ...
              <tr><td colSpan="6" className="px-6 py-12 text-center text-gray-500">All stock levels are healthy!</td></tr>
            ) : (
              lowStockItems.map((item) => (
                <tr key={item.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4 font-medium">{item.medicine?.name}</td>
                  <td className="px-6 py-4 text-gray-500 font-mono text-sm">{item.batch_no || 'N/A'}</td>
                  ...
                  <td className="px-6 py-4">
                    <Link to="/pharmacy/supply-requests" className="text-green-600 hover:text-green-700 text-sm font-medium flex items-center gap-1">
