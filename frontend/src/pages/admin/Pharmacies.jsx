                ...
                <div>
                  ...
                  <div className="flex">
                    <input
                      ...
                      className="w-full border rounded-l-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-green-500"
                      placeholder="health-plus"
                    />
                    <span className="bg-gray-100 border border-l-0 rounded-r-lg px-3 py-2.5 text-gray-500 text-sm">.yourplatform.com</span>
                  </div>
                </div>
                <div>
