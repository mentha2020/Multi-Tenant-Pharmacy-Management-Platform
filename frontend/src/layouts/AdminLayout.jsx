...
import { LayoutDashboard, Building2, Package, ShoppingCart, Truck, BarChart3, Settings, LogOut, ChevronDown, Bell, Sun, Moon } from 'lucide-react';
          ...
          <div className="relative">
            ...
            {showDropdown && (
              <div className="absolute bottom-full left-0 w-full mb-2 bg-gray-800 dark:bg-gray-700 rounded-lg shadow-lg overflow-hidden z-50">
                <button
                  onClick={logout}
                  className="flex items-center gap-2 w-full px-4 py-3 text-gray-400 hover:bg-gray-700 dark:hover:bg-gray-600 hover:text-white"
                >
        ...
        <header className="bg-white dark:bg-gray-800 shadow-sm sticky top-0 z-40 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between px-6 py-4">
            <div className="min-w-0">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">Here's what's happening with your platform</p>
            </div>
            <div className="flex items-center gap-4 flex-shrink-0">
              ...
              <Link to="/" className="text-sm text-gray-600 dark:text-gray-400 hover:text-green-600 dark:hover:text-green-400 whitespace-nowrap">
                View Website
              </Link>
            </div>
          </div>
