...
import { LayoutDashboard, Package, Warehouse, ShoppingCart, CreditCard, Settings, LogOut, ChevronDown, Bell } from 'lucide-react';
        ...
        <div className="p-4 border-b border-gray-800">
          <Link to="/pharmacy/dashboard" className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">{user?.pharmacy?.name || 'Pharmacy Panel'}</p>
            </div>
          </Link>
        </div>
        ...
        <header className="bg-white shadow-sm sticky top-0 z-40">
          <div className="flex items-center justify-between px-6 py-4">
            <div>
              ...
              <p className="text-sm text-gray-500">{user?.pharmacy?.name}</p>
            </div>
            <div className="flex items-center gap-4">
              ...
              <Link to="/" className="text-sm text-gray-600 hover:text-green-600">View Website</Link>
            </div>
          </div>
        </header>
